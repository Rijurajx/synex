...
interface HeroSequenceProps {
  onScrollUpdate: (progress: number, isActive: boolean) => void;
  onLoaded: (fadingOut: boolean) => void;
...
export function HeroSequence({ 
  onScrollUpdate, 
  onLoaded,
  activeSection: pageActiveSection = 0,
  scrollProgress: pageScrollProgress = 0
}: HeroSequenceProps) {
  ...
  useEffect(() => {
    ...
    const scrollTriggerInstance = ScrollTrigger.create({
      ...
      onUpdate: (self) => {
        ...
        onScrollUpdate(self.progress, self.isActive);
      },
    });
  ...
  const canvasOpacity = pageActiveSection <= 1 ? 1 : 0;

  return (
    <div ref={containerRef} className="relative w-full bg-transparent select-none">
      {/* Viewport Container holding the canvas */}
      <div 
        className="fixed top-0 left-0 w-full h-screen overflow-hidden flex items-center justify-center bg-black pointer-events-none"
        style={{ 
          ...
          <div className="relative flex flex-col items-center w-full max-w-[540px] px-6">
            ...
            <div className="w-full bg-zinc-950/80 border border-white/10 px-6 py-6 flex flex-col justify-between select-none relative z-10">
              ...
              <div className="flex justify-between items-center my-6">
                {/* Main Title */}
                <h1 className="text-3xl md:text-4xl font-oxanium font-black tracking-[0.2em] text-white uppercase leading-none">
                  SYNEX
                </h1>
